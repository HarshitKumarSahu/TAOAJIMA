...
//                 uHover: { value: new THREE.Vector2(0.5, 0.5) },
//                 uHoverState: { value: 0 },
//                 uIsFullScreen: { value: 0 }, // New uniform to track full-screen state
//                 aspect: { value: new THREE.Vector2(1, 1) },
//                 uProgress: { value: 0 },
//                 uCorners: { value: new THREE.Vector4(0, 0, 0, 0) },
//                 uTextureSize: { value: new THREE.Vector2(1, 1) },
...
//             img.addEventListener("mouseenter", () => {
//                 if (!imgMat.uniforms.uIsFullScreen.value) {
//                     gsap.to(imgMat.uniforms.uHoverState, {
//                         duration: 0.5,
//                         value: 1,
//                         ease: "circ.inOut",
...
//             let imgMesh = new THREE.Mesh(imgGeo, imgMat);
//             imgMesh.scale.set(imgBounds.width, imgBounds.height, 1);
//             imgMesh.userData = { isFullScreen: false }; // Track full-screen state
//             this.scene.add(imgMesh);
...
//         this.imageStore.forEach(i => {
//             i.img.addEventListener('click', () => {
//                 const isFullScreen = i.mesh.userData.isFullScreen;
//                 let tl = gsap.timeline();

//                 if (!isFullScreen) {
//                     // Enter full-screen
//                     tl.to(i.mesh.material.uniforms.uCorners.value, { w: 1, duration: 0.4 })
//                       .to(i.mesh.material.uniforms.uCorners.value, { y: 1, duration: 0.4 }, 0.1)
//                       .to(i.mesh.material.uniforms.uCorners.value, { z: 1, duration: 0.4 }, 0.2)
//                       .to(i.mesh.material.uniforms.uCorners.value, { x: 1, duration: 0.4 }, 0.3)
//                       .to(i.mesh.material.uniforms.uIsFullScreen, { value: 1, duration: 0 }, 0);
//                     i.mesh.userData.isFullScreen = true;
//                 } else {
//                     // Exit full-screen
//                     tl.to(i.mesh.material.uniforms.uCorners.value, { x: 0, duration: 0.4 })
//                       .to(i.mesh.material.uniforms.uCorners.value, { z: 0, duration: 0.4 }, 0.1)
//                       .to(i.mesh.material.uniforms.uCorners.value, { y: 0, duration: 0.4 }, 0.2)
//                       .to(i.mesh.material.uniforms.uCorners.value, { w: 0, duration: 0.4 }, 0.3)
//                       .to(i.mesh.material.uniforms.uIsFullScreen, { value: 0, duration: 0 }, 0);
//                     i.mesh.userData.isFullScreen = false;
//                 }
//             });
//         });
//     }
...
export default class Three {
    ...
    addImages() {
        ...
        this.imageStore = this.images.map((img, index) => {
            ...
            let imgMesh = new THREE.Mesh(imgGeo, imgMat);
            imgMesh.scale.set(imgBounds.width, imgBounds.height, 1);
            imgMesh.userData = { isFullScreen: false };
            this.scene.add(imgMesh);
            ...
            img.addEventListener("mouseenter", () => {
                if (!imgMat.uniforms.uIsFullScreen.value) {
                    ...
                    gsap.to(imgMesh.scale , {
                        x : imgBounds.width * 1.25,
                        y: imgBounds.height * 1.25
                    })
                    // imgMesh.scale.set(imgBounds.width * 1.25, imgBounds.height * 1.25, 1);
                }
            });
            ...
            img.addEventListener("mouseleave", () => {
                if (!imgMat.uniforms.uIsFullScreen.value) {
                    ...
                    // imgMesh.scale.set(imgBounds.width * 1, imgBounds.height * 1, 1);
                }
            });
            ...
            i.img.addEventListener('click', () => {
                ...
                if (!isFullScreen) {
                    tl.to(i.mesh.material.uniforms.uCorners.value, { w: 1, duration: 0.4 })
                      ...
                      .to(i.mesh.material.uniforms.uCorners.value, { x: 1, duration: 0.4 }, 0.3)
                      .to(i.mesh.material.uniforms.uIsFullScreen, { value: 1, duration: 0 }, 0)
                      .to(i.mesh.material.uniforms.uProgress, { value: 1, duration: 0.7, ease: "linear" }, 0);
                    i.mesh.userData.isFullScreen = true;
                } else {
                    tl.to(i.mesh.material.uniforms.uCorners.value, { x: 0, duration: 0.4 })
                      .to(i.mesh.material.uniforms.uCorners.value, { z: 0, duration: 0.4 }, 0.1)
                      ...
                      .to(i.mesh.material.uniforms.uCorners.value, { w: 0, duration: 0.4 }, 0.3)
                      .to(i.mesh.material.uniforms.uIsFullScreen, { value: 0, duration: 0 }, 0)
                      .to(i.mesh.material.uniforms.uProgress, { value: 0, duration: 0.7, ease: "linear" }, 0);
                    i.mesh.userData.isFullScreen = false;
                }
            });
        });
